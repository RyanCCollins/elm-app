...
var _ryanccollins$race_tracker$AddRunner$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _ryanccollins$race_tracker$AddRunner$errorPanel = function (error) {
	var _p0 = error;
	if (_p0.ctor === 'Nothing') {
...
var _ryanccollins$race_tracker$AddRunner$bibInput = F2(
	function (model, bib) {
		var bibInt = A2(
...
var _ryanccollins$race_tracker$AddRunner$ageInput = F2(
	function (model, age) {
		var ageInt = A2(
			_elm_lang$core$Result$withDefault,
			0,
...
var _ryanccollins$race_tracker$AddRunner$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'NameInput':
			...
			case 'AgeInput':
				return A2(_ryanccollins$race_tracker$AddRunner$ageInput, model, _p1._0);
			case 'BibInput':
				return A2(_ryanccollins$race_tracker$AddRunner$bibInput, model, _p1._0);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _ryanccollins$race_tracker$AddRunner$initModel = {id: '', name: '', nameError: _elm_lang$core$Maybe$Nothing, location: '', locationError: _elm_lang$core$Maybe$Nothing, age: '', ageError: _elm_lang$core$Maybe$Nothing, bib: '', bibError: _elm_lang$core$Maybe$Nothing, error: _elm_lang$core$Maybe$Nothing};
var _ryanccollins$race_tracker$AddRunner$init = {ctor: '_Tuple2', _0: _ryanccollins$race_tracker$AddRunner$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _ryanccollins$race_tracker$AddRunner$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _ryanccollins$race_tracker$AddRunner$Save = {ctor: 'Save'};
var _ryanccollins$race_tracker$AddRunner$BibInput = function (a) {
	return {ctor: 'BibInput', _0: a};
};
var _ryanccollins$race_tracker$AddRunner$AgeInput = function (a) {
	return {ctor: 'AgeInput', _0: a};
};
var _ryanccollins$race_tracker$AddRunner$LocationInput = function (a) {
	return {ctor: 'LocationInput', _0: a};
};
var _ryanccollins$race_tracker$AddRunner$NameInput = function (a) {
	return {ctor: 'NameInput', _0: a};
};
var _ryanccollins$race_tracker$AddRunner$viewForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(_ryanccollins$race_tracker$AddRunner$Save),
				_1: {ctor: '[]'}
			}
		},
		{
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$AddRunner$NameInput),
													_1: {ctor: '[]'}
												}
											}
										},
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$AddRunner$LocationInput),
														_1: {ctor: '[]'}
													}
												}
											},
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$AddRunner$AgeInput),
															_1: {ctor: '[]'}
														}
													}
												},
												...
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$AddRunner$BibInput),
																_1: {ctor: '[]'}
															}
														}
													},
...
var _ryanccollins$race_tracker$AddRunner$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _ryanccollins$race_tracker$AddRunner$errorPanel(model.error),
			_1: {
				ctor: '::',
				_0: _ryanccollins$race_tracker$AddRunner$viewForm(model),
				_1: {ctor: '[]'}
			}
		});
};

var _ryanccollins$race_tracker$LeaderBoard$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _ryanccollins$race_tracker$LeaderBoard$runnersHeader = A2(
...
var _ryanccollins$race_tracker$LeaderBoard$runner = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
...
var _ryanccollins$race_tracker$LeaderBoard$runners = function (_p2) {
	var _p3 = _p2;
	return A2(
		...
		function (r) {
			return {
				ctor: '::',
				_0: _ryanccollins$race_tracker$LeaderBoard$runnersHeader,
				_1: {
					ctor: '::',
					_0: r,
					_1: {ctor: '[]'}
			...
			A2(
				...
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _ryanccollins$race_tracker$LeaderBoard$runner, _p3.runners))));
};
var _ryanccollins$race_tracker$LeaderBoard$errorPanel = function (error) {
	var _p4 = error;
	if (_p4.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('');
	} else {
...
var _ryanccollins$race_tracker$LeaderBoard$update = F2(
	function (msg, model) {
		var _p5 = msg;
...
var _ryanccollins$race_tracker$LeaderBoard$Model = F4(
	function (a, b, c, d) {
		return {error: a, query: b, runners: c, active: d};
	});
var _ryanccollins$race_tracker$LeaderBoard$Runner = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {id: a, name: b, location: c, age: d, bib: e, estimatedDistance: f, lastMarkerDistance: g, lastMarkerTime: h, pace: i};
	});
var _ryanccollins$race_tracker$LeaderBoard$tempRunners = {
	ctor: '::',
	_0: A9(_ryanccollins$race_tracker$LeaderBoard$Runner, '1', 'James Moore', 'Turlock CA', 42, 1234, 0, 1, 1463154945381, 0.125),
	_1: {
		ctor: '::',
		_0: A9(_ryanccollins$race_tracker$LeaderBoard$Runner, '2', 'Meb Keflezighi', 'Turlock CA', 41, 1238, 0, 1, 1463154945381, 9.0e-2),
		_1: {ctor: '[]'}
	}
};
var _ryanccollins$race_tracker$LeaderBoard$initModel = {error: _elm_lang$core$Maybe$Nothing, query: '', runners: _ryanccollins$race_tracker$LeaderBoard$tempRunners, active: false};
var _ryanccollins$race_tracker$LeaderBoard$init = {ctor: '_Tuple2', _0: _ryanccollins$race_tracker$LeaderBoard$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _ryanccollins$race_tracker$LeaderBoard$Search = {ctor: 'Search'};
var _ryanccollins$race_tracker$LeaderBoard$SearchInput = function (a) {
	return {ctor: 'SearchInput', _0: a};
};
var _ryanccollins$race_tracker$LeaderBoard$searchForm = function (query) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_ryanccollins$race_tracker$LeaderBoard$Search),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$LeaderBoard$SearchInput),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _ryanccollins$race_tracker$LeaderBoard$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _ryanccollins$race_tracker$LeaderBoard$errorPanel(model.error),
			_1: {
				ctor: '::',
				_0: _ryanccollins$race_tracker$LeaderBoard$searchForm(model.query),
				_1: {
					ctor: '::',
					_0: _ryanccollins$race_tracker$LeaderBoard$runners(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _ryanccollins$race_tracker$Login$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _ryanccollins$race_tracker$Login$errorPanel = function (error) {
	var _p0 = error;
	if (_p0.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('');
	} else {
...
var _ryanccollins$race_tracker$Login$url = 'http://localhost:5000/authenticate';
var _ryanccollins$race_tracker$Login$initModel = {username: '', password: '', error: _elm_lang$core$Maybe$Nothing};
var _ryanccollins$race_tracker$Login$init = {ctor: '_Tuple2', _0: _ryanccollins$race_tracker$Login$initModel, _1: _elm_lang$core$Platform_Cmd$none};
var _ryanccollins$race_tracker$Login$Model = F3(
	function (a, b, c) {
		return {username: a, password: b, error: c};
	});
var _ryanccollins$race_tracker$Login$LoginResponse = function (a) {
	return {ctor: 'LoginResponse', _0: a};
};
var _ryanccollins$race_tracker$Login$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UsernameInput':
			...
			case 'Submit':
				...
				var request = A3(_elm_lang$http$Http$post, _ryanccollins$race_tracker$Login$url, body, decoder);
				var cmd = A2(_elm_lang$http$Http$send, _ryanccollins$race_tracker$Login$LoginResponse, request);
			...
			default:
				if (_p1._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple3',
						_0: _ryanccollins$race_tracker$Login$initModel,
...
var _ryanccollins$race_tracker$Login$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _ryanccollins$race_tracker$Login$Submit = {ctor: 'Submit'};
var _ryanccollins$race_tracker$Login$PasswordInput = function (a) {
	return {ctor: 'PasswordInput', _0: a};
};
var _ryanccollins$race_tracker$Login$UsernameInput = function (a) {
	return {ctor: 'UsernameInput', _0: a};
};
var _ryanccollins$race_tracker$Login$loginForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(_ryanccollins$race_tracker$Login$Submit),
				_1: {ctor: '[]'}
			}
		},
		{
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$Login$UsernameInput),
													_1: {ctor: '[]'}
												}
											}
										},
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_ryanccollins$race_tracker$Login$PasswordInput),
														_1: {ctor: '[]'}
													}
												}
											},
...
var _ryanccollins$race_tracker$Login$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _ryanccollins$race_tracker$Login$errorPanel(model.error),
			_1: {
				ctor: '::',
				_0: _ryanccollins$race_tracker$Login$loginForm(model),
				_1: {ctor: '[]'}
			}
		});
};

var _ryanccollins$race_tracker$Main$pageToHash = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
...
var _ryanccollins$race_tracker$Main$saveToken = _elm_lang$core$Native_Platform.outgoingPort(
	'saveToken',
	function (v) {
		return v;
	});
var _ryanccollins$race_tracker$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {page: a, leaderBoard: b, login: c, runner: d, token: e, loggedIn: f};
	});
var _ryanccollins$race_tracker$Main$Flags = function (a) {
	return {token: a};
};
var _ryanccollins$race_tracker$Main$AddRunnerPage = {ctor: 'AddRunnerPage'};
var _ryanccollins$race_tracker$Main$LoginPage = {ctor: 'LoginPage'};
var _ryanccollins$race_tracker$Main$LeaderBoardPage = {ctor: 'LeaderBoardPage'};
var _ryanccollins$race_tracker$Main$NotFound = {ctor: 'NotFound'};
var _ryanccollins$race_tracker$Main$hashToPage = function (hash) {
	var _p1 = hash;
	switch (_p1) {
		case '#/':
			return _ryanccollins$race_tracker$Main$LeaderBoardPage;
		case '#login':
			return _ryanccollins$race_tracker$Main$LoginPage;
		case '':
			return _ryanccollins$race_tracker$Main$LeaderBoardPage;
		case '#addRunner':
			return _ryanccollins$race_tracker$Main$AddRunnerPage;
		default:
			return _ryanccollins$race_tracker$Main$NotFound;
	}
};
var _ryanccollins$race_tracker$Main$RunnerMsg = function (a) {
	return {ctor: 'RunnerMsg', _0: a};
};
var _ryanccollins$race_tracker$Main$LoginMsg = function (a) {
	return {ctor: 'LoginMsg', _0: a};
};
var _ryanccollins$race_tracker$Main$LeaderBoardMsg = function (a) {
	return {ctor: 'LeaderBoardMsg', _0: a};
};
var _ryanccollins$race_tracker$Main$init = F2(
	function (flags, location) {
		var _p2 = _ryanccollins$race_tracker$AddRunner$init;
		var runnerInitModel = _p2._0;
		var runnerCmd = _p2._1;
		var _p3 = _ryanccollins$race_tracker$Login$init;
		var loginInitModel = _p3._0;
		var loginCmd = _p3._1;
		var _p4 = _ryanccollins$race_tracker$LeaderBoard$init;
		var leaderboardInitModel = _p4._0;
		var leaderboardCmd = _p4._1;
		var cmds = _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _ryanccollins$race_tracker$Main$LeaderBoardMsg, leaderboardCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _ryanccollins$race_tracker$Main$LoginMsg, loginCmd),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _ryanccollins$race_tracker$Main$RunnerMsg, runnerCmd),
						_1: {ctor: '[]'}
					}
				}
			});
		var page = _ryanccollins$race_tracker$Main$hashToPage(location.hash);
		var initModel = {
			page: page,
...
var _ryanccollins$race_tracker$Main$update = F2(
	function (msg, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'Navigate':
				return {
					...
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(
						_ryanccollins$race_tracker$Main$pageToHash(_p5._0))
				};
			case 'ChangePage':
				return {
					ctor: '_Tuple2',
			...
			case 'LeaderBoardMsg':
				var _p6 = A2(_ryanccollins$race_tracker$LeaderBoard$update, _p5._0, model.leaderBoard);
				...
				return {
					...
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ryanccollins$race_tracker$Main$LeaderBoardMsg, cmd)
				};
			case 'LoginMsg':
				var _p7 = A2(_ryanccollins$race_tracker$Login$update, _p5._0, model.login);
				...
				var saveTokenCmd = function () {
					var _p8 = token;
					if (_p8.ctor === 'Just') {
						return _ryanccollins$race_tracker$Main$saveToken(_p8._0);
					} else {
				...
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _ryanccollins$race_tracker$Main$LoginMsg, cmd),
							_1: {
								ctor: '::',
								_0: saveTokenCmd,
								_1: {ctor: '[]'}
			...
			default:
				var _p9 = A2(_ryanccollins$race_tracker$AddRunner$update, _p5._0, model.runner);
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{runner: runnerModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _ryanccollins$race_tracker$Main$RunnerMsg, cmd)
				};
		}
	});
var _ryanccollins$race_tracker$Main$subscriptions = function (model) {
	var runnerSub = _ryanccollins$race_tracker$AddRunner$subscriptions(model.runner);
	var loginSub = _ryanccollins$race_tracker$Login$subscriptions(model.login);
	var leaderBoardSub = _ryanccollins$race_tracker$LeaderBoard$subscriptions(model.leaderBoard);
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _ryanccollins$race_tracker$Main$LeaderBoardMsg, leaderBoardSub),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Sub$map, _ryanccollins$race_tracker$Main$LoginMsg, loginSub),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Sub$map, _ryanccollins$race_tracker$Main$RunnerMsg, runnerSub),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _ryanccollins$race_tracker$Main$ChangePage = function (a) {
	return {ctor: 'ChangePage', _0: a};
};
var _ryanccollins$race_tracker$Main$locationToMessage = function (location) {
	return _ryanccollins$race_tracker$Main$ChangePage(
		_ryanccollins$race_tracker$Main$hashToPage(location.hash));
};
var _ryanccollins$race_tracker$Main$Navigate = function (a) {
	return {ctor: 'Navigate', _0: a};
};
var _ryanccollins$race_tracker$Main$pageHeader = function (model) {
	return A2(
			...
			_0: A2(
				_elm_lang$html$Html$a,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_ryanccollins$race_tracker$Main$Navigate(_ryanccollins$race_tracker$Main$LeaderBoardPage)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_ryanccollins$race_tracker$Main$Navigate(_ryanccollins$race_tracker$Main$AddRunnerPage)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_ryanccollins$race_tracker$Main$Navigate(_ryanccollins$race_tracker$Main$LoginPage)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _ryanccollins$race_tracker$Main$view = function (model) {
	var page = function () {
		var _p10 = model.page;
		switch (_p10.ctor) {
			case 'AddRunnerPage':
				return A2(
					...
					_ryanccollins$race_tracker$Main$RunnerMsg,
					_ryanccollins$race_tracker$AddRunner$view(model.runner));
			case 'LeaderBoardPage':
				return A2(
					_elm_lang$html$Html$map,
					_ryanccollins$race_tracker$Main$LeaderBoardMsg,
					_ryanccollins$race_tracker$LeaderBoard$view(model.leaderBoard));
			case 'LoginPage':
				return A2(
					_elm_lang$html$Html$map,
					_ryanccollins$race_tracker$Main$LoginMsg,
					_ryanccollins$race_tracker$Login$view(model.login));
			default:
				return A2(
					_elm_lang$html$Html$div,
					{
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _ryanccollins$race_tracker$Main$pageHeader(model),
			_1: {
				ctor: '::',
				_0: page,
				_1: {ctor: '[]'}
...
var _ryanccollins$race_tracker$Main$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_ryanccollins$race_tracker$Main$locationToMessage,
	{init: _ryanccollins$race_tracker$Main$init, update: _ryanccollins$race_tracker$Main$update, view: _ryanccollins$race_tracker$Main$view, subscriptions: _ryanccollins$race_tracker$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (token) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ryanccollins$race_tracker$Main$main !== 'undefined') {
    _ryanccollins$race_tracker$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Login.Msg":{"args":[],"tags":{"UsernameInput":["String"],"Error":["String"],"Submit":[],"LoginResponse":["Result.Result Http.Error String"],"PasswordInput":["String"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"LeaderBoard.Msg":{"args":[],"tags":{"SearchInput":["String"],"Search":[]}},"Main.Msg":{"args":[],"tags":{"LoginMsg":["Login.Msg"],"Navigate":["Main.Page"],"ChangePage":["Main.Page"],"LeaderBoardMsg":["LeaderBoard.Msg"],"RunnerMsg":["AddRunner.Msg"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Main.Page":{"args":[],"tags":{"LeaderBoardPage":[],"NotFound":[],"AddRunnerPage":[],"LoginPage":[]}},"AddRunner.Msg":{"args":[],"tags":{"BibInput":["String"],"AgeInput":["String"],"LocationInput":["String"],"NameInput":["String"],"Save":[]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
